...
class AttentionalGNN(nn.Module):
    ...
    def forward(self, desc0, desc1, L):
        i = 0
        k0_list = [desc0.shape[2]//2, None, desc0.shape[2]//2, None, desc0.shape[2]//4, None, desc0.shape[2]//4, None]
        k1_list = [desc1.shape[2]//2, None, desc1.shape[2]//2, None, desc1.shape[2]//4, None, desc1.shape[2]//4, None]
