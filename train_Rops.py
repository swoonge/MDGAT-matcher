...
parser.add_argument(
    '--batch_size', type=int, default=64, #128
    help='Batch size')
...
if __name__ == '__main__':
    ...
    if opt.resume:
        ...
        lr_schedule = optim.lr_scheduler.StepLR(optimizer, step_size=20, gamma=0.1)
    ...
    for epoch in range(start_epoch, opt.epoch+1):
        ...
        with torch.no_grad():
            ...
            print('Validation loss: {:.4f}, epoch_loss: {:.4f}, best val loss: {:.4f}, lr: {:.10f}' .format(mean_val_loss, epoch_loss, best_loss, lr_schedule.get_lr()[0]))
            checkpoint = {
                    "net": net.state_dict(),
            ...
            logger.add_scalar('Train/rl', lr_schedule.get_lr()[0], epoch)
