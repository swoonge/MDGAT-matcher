...
if __name__ == '__main__':
    ...
    if opt.net == 'raw':
        ...
        opt.l = 9
    if opt.mutual_check:
        model_name = '{}-batch{}-{}-{}-{}-{}' .format(opt.net, opt.k, opt.batch_size, opt.loss_method, opt.descriptor, opt.keypoints, today)
    else:
        model_name = 'nomutualcheck-{}-batch{}-{}-{}-{}-{}' .format(opt.net, opt.batch_size, opt.loss_method, opt.descriptor, opt.keypoints, today)
